...
@ thiscall -arch=i386 ??0__non_rtti_object@@QAE@PBD@Z(ptr ptr) MSVCRT___non_rtti_object_copy_ctor
@ cdecl -arch=win64 ??0__non_rtti_object@@QEAA@PEBD@Z(ptr ptr) MSVCRT___non_rtti_object_copy_ctor
...
@ stub -arch=i386 ?what@exception@@UBEPBDXZ
@ stub -arch=win64 ?what@exception@@UEBAPEBDXZ
;@ thiscall -arch=i386 ?what@exception@@UBEPBDXZ(ptr) MSVCRT_exception_what
;@ cdecl -arch=win64 ?what@exception@@UEBAPEBDXZ(ptr) MSVCRT_exception_what
...
@ cdecl __security_error_handler(long ptr) __security_error_handler
@ cdecl __set_app_type(long)
@ stub __set_buffer_overrun_handler
@ extern __setlc_active
@ cdecl __setusermatherr(ptr)
@ cdecl __threadhandle() MSVCRT_kernel32.GetCurrentThread
@ cdecl __threadid() MSVCRT_kernel32.GetCurrentThreadId
...
@ cdecl -arch=win32 _ftime(ptr) _ftime_s
@ cdecl -arch=win64 _ftime(ptr) _ftime_s
@ cdecl _ftime64(ptr)
...
@ cdecl _getdrive()
@ cdecl _getdrives() MSVCRT_kernel32.GetLogicalDrives
@ cdecl _getmaxstdio()
@ cdecl _getmbcp()
@ cdecl _getpid()
...
;@ cdecl -private atexit(ptr) _atexit  # not imported to avoid conflicts with Mingw
...
@ varargs swprintf(ptr wstr) swprintf
...
@ cdecl vswprintf(ptr wstr ptr) vswprintf
