...
_CRTIMP errno_t __cdecl _controlfp_s(unsigned int *, unsigned int, unsigned int);
#ifdef __i386__
...
_CRTIMP double __cdecl _scalb(double, __msvcrt_long);
...
#ifdef __x86_64__
_CRTIMP float __cdecl _scalbf(float, __msvcrt_long);
#endif
