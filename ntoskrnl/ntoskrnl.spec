...
@ stdcall -arch=i386,amd64,arm -version=0x600+ KeQueryActiveProcessorCount(long)
@ stdcall -arch=i386,amd64,arm -version=0x600+ KeQueryActiveProcessorCountEx(long)
